    ...
    >
      <FlexBetween m="1rem 2.5rem" gap="1rem">
        <Box>
          ...
          <Typography variant='h6'>charted revenue and predicted revenue based on simple linear regression model
          </Typography>
        </Box>
        <Button
      ...
      <ResponsiveContainer width="100%" height="100%">
          ...
          >
            <CartesianGrid strokeDasharray="3 3"color={palette.grey[800]}/>
            <XAxis
              dataKey="name"
              tickLine={false}
              style={{ fontSize: "10px" }}
